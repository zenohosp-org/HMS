...
export default function Unauthorized() {
    ...
    // DOCTOR/STAFF that logged in but were never added to a hospital by an admin
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 px-4">
            <div className="card p-10 max-w-md w-full text-center">
                <div className="text-6xl mb-4">{isUnregisteredStaff ? '🏥' : '🔒'}</div>

                <h1 className="text-xl font-semibold text-slate-800 dark:text-slate-200 mb-3">
                    {isUnregisteredStaff
