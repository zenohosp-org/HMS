...
function RadiologyReports() {
  ...
  return <div className="space-y-5"><div className="flex items-start justify-between gap-4 flex-wrap"><div><h1 className="text-xl font-bold text-slate-900 dark:text-[#f0f0f0] flex items-center gap-2"><FileText className="w-5 h-5 text-slate-700 dark:text-slate-500" /> Radiology Reports
      ...
      /></div>{
      /* Reports table */
    }<div className="bg-white dark:bg-[#111111] border border-slate-200 dark:border-[#1e1e1e] rounded-lg overflow-hidden"><div className="px-6 py-4 border-b border-slate-100 dark:border-[#1e1e1e]"><p className="text-sm font-bold text-slate-800 dark:text-[#dddddd]">Completed Reports</p><p className="text-xs text-slate-600 dark:text-[#999999] mt-0.5">Radiology reports with findings</p></div>{loading ? <div className="flex items-center justify-center py-16"><Loader2 className="w-5 h-5 animate-spin text-slate-600" /></div> : filtered.length === 0 ? <div className="flex flex-col items-center justify-center py-16 gap-2 text-slate-600 dark:text-[#999999]"><FileText className="w-8 h-8 opacity-30" /><p className="text-sm">{search ? "No reports match your search" : "No completed reports yet"}</p></div> : <>{
      /* Column headers */
      ...
      /* Patient */
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-200 dark:border-[#333] text-xs font-bold text-slate-700 dark:text-slate-500 hover:bg-slate-50 dark:hover:bg-[#1a1a1a] transition-colors"
