...
function CreateInvoice() {
  ...
  ><p className="text-sm font-semibold text-slate-800 dark:text-[#dddddd]">{p.firstName} {p.lastName}</p><p className="text-xs text-slate-400">{p.uhid}</p></button>)}</div>}</div>}</div>{
    /* Smart Suggestions */
