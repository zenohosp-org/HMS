...
import { Plus, Filter, MoreHorizontal, Edit, Trash2, Loader2, Stethoscope } from "lucide-react";
...
function Specializations() {
  ...
  /><div className="absolute right-6 top-14 w-44 bg-white dark:bg-[#1a1a1a] rounded-xl shadow-xl border border-slate-100 dark:border-[#252525] z-20 py-1.5 animate-in slide-in-from-top-2 duration-150"><button
    onClick={() => {
      setEditingSpec(spec);
      setIsModalOpen(true);
