...
function DoctorsList() {
  ...
  return <div className="flex flex-col h-full bg-slate-50 dark:bg-[#050505] p-6 gap-6">{
    /* Header */
  ...
  /></div>{
    ...
    ><MoreHorizontal className="w-5 h-5" /></button>{openMenuId === d.id && <><div className="fixed inset-0 z-10" onClick={() => setOpenMenuId(null)} /><div
      className="absolute right-6 top-14 w-48 bg-white dark:bg-[#1a1a1a] rounded-xl shadow-xl border border-slate-100 dark:border-[#252525] z-20 py-1.5"
    ...
    ><XCircle className="w-4 h-4" /> Deactivate Login
      ...
      className="w-full flex items-center gap-2.5 px-3 py-2 text-sm font-semibold text-slate-900 dark:text-white hover:bg-slate-100 dark:bg-[#1e1e1e] dark:hover:bg-emerald-900/10 transition-all"
