...
export default function DoctorsList() {
    ...
    return (
        <div className="flex flex-col h-full bg-slate-50 dark:bg-[#050505] p-6 gap-6">
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-slate-50 dark:divide-[#1a1a1a]">
                            {loading ? (
                                ...
                                <tr>
                                    <td colSpan={5} className="py-20 text-center">
                                        <div className="flex flex-col items-center gap-3">
                                            ...
                                            <p className="text-sm font-medium text-slate-400">{search ? 'No doctors match your search.' : 'No doctors linked to this hospital.'}</p>
                                        </div>
                                    </td>
                                </tr>
                            ) : paginated.map(d => {
                                ...
                                return (
                                    <tr key={d.id} className="group hover:bg-slate-50/50 dark:hover:bg-[#151515] transition-all">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-slate-400 dark:text-slate-500 mt-0.5">{d.qualification || 'N/A'}</p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-6 py-4">
                                            ...
                                            <p className="text-xs text-slate-400 dark:text-slate-500 mt-0.5">{d.phone}</p>
                                        </td>
                                        <td className="px-6 py-4">
            ...
            {showModal && (
                <DoctorFormModal onClose={() => setShowModal(false)} onSaved={() => { setShowModal(false); load() }} />
            )}
        </div>
    )
}
