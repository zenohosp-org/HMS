...
export default function DischargeModal({ admission, onClose, onDischarged }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-white dark:bg-[#111] rounded-lg shadow-2xl w-full max-w-lg border border-slate-200 dark:border-[#2a2a2a]">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end gap-3 p-5 border-t border-slate-100 dark:border-[#1e1e1e] bg-slate-50 dark:bg-[#0a0a0a] rounded-b-2xl">
            ...
            <button type="submit" disabled={submitting}
              className="px-5 py-2.5 rounded-lg text-sm font-semibold bg-rose-500 hover:bg-rose-600 text-white flex items-center gap-2 transition-colors disabled:opacity-50">
