...
function RoomActionMenu({ room, onAllocate, onAssignAttender, onDeallocate }: {
    ...
    return (
        <div ref={ref} className="relative shrink-0">
            ...
            {open && (
                <div className="absolute right-0 top-full mt-1 z-20 w-44 bg-white dark:bg-[#1a1a1a] border border-slate-200 dark:border-[#2a2a2a] rounded-xl shadow-lg overflow-hidden">
...
export default function Rooms() {
    ...
    // Keep selectedRoom in sync with latest fetched data
    useEffect(() => {
        if (selectedRoom) {
