    ...
    return (
        <div className="w-80 shrink-0 bg-white dark:bg-[#111111] border border-slate-200 dark:border-[#1e1e1e] rounded-2xl flex flex-col overflow-hidden self-start sticky top-0">
            ...
            <div className="flex items-start justify-between p-5 border-b border-slate-100 dark:border-[#1e1e1e]">
                <div>
                    <p className="text-xs font-semibold text-slate-400 dark:text-[#666666] uppercase tracking-wider mb-1">
                        {room.roomNumber}
                    </p>
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-5">
                ...
                {room.allocationToken && (
                    <div className="flex items-center justify-between px-3 py-2.5 rounded-xl bg-violet-50 dark:bg-violet-500/10 border border-violet-200 dark:border-violet-500/20">
                        ...
                        <span className="text-sm font-bold tracking-widest text-violet-700 dark:text-violet-300 font-mono">
                            {room.allocationToken}
                        </span>
                    </div>
                )}
                ...
                <div>
                    ...
                    {room.attenderName ? (
                        <div className="space-y-1.5 pl-1">
                            <div className="flex items-center gap-2">
                                <p className="text-sm font-semibold text-slate-800 dark:text-[#dddddd]">
                                    {room.attenderName}
                                </p>
                ...
                <div>
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <p className="text-xs font-bold text-slate-500 dark:text-[#666666] uppercase tracking-wider">Assets in Room</p>
                    </div>
                    <div className="pl-1 py-4 flex flex-col items-center justify-center rounded-xl border border-dashed border-slate-200 dark:border-[#2a2a2a]">
