  ...
  return (
    <div ref={ref} className="relative shrink-0">
      <button
        ...
        className={`rounded-lg text-slate-400 hover:text-slate-700 dark:hover:text-slate-300 hover:bg-slate-100 dark:hover:bg-[#1a1a1a] transition-all ${compact ? "p-1" : "p-2"}`}
      >
        <MoreHorizontal className={compact ? "w-3.5 h-3.5" : "w-5 h-5"} />
      </button>
      {open && (
          ...
          {loading ? (
            ...
            <div className="space-y-3">
              {filteredInfrastructure.map((building, bIdx) => (
                <div key={building.id ?? bIdx} className="rounded-xl border border-slate-200 dark:border-[#2a2a2a] overflow-hidden bg-white dark:bg-[#111111]">
                  {/* Building header */}
                  <div className="flex items-center justify-between px-4 py-2.5 bg-slate-50 dark:bg-[#0d0d0d] border-b border-slate-200 dark:border-[#1e1e1e]">
                  ...
                  <div className="p-3 space-y-3">
                    {building.floors.map((floor, fIdx) => (
                      <div key={floor.id ?? fIdx} className="rounded-lg border border-slate-100 dark:border-[#1e1e1e] overflow-hidden">
                        {/* Floor header */}
                        <div className="flex items-center justify-between px-3 py-2 bg-slate-50/80 dark:bg-[#0f0f0f] border-b border-slate-100 dark:border-[#1e1e1e]">
                          <div className="flex items-center gap-1.5">
              ...
              {unmappedRooms.length > 0 && (
                <div className="rounded-xl border border-slate-200 dark:border-[#2a2a2a] bg-white dark:bg-[#111111] overflow-hidden">
                  <div className="flex items-center justify-between px-4 py-2.5 bg-slate-50 dark:bg-[#0d0d0d] border-b border-slate-200 dark:border-[#1e1e1e]">
