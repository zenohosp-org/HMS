...
function Rooms() {
  ...
  ><ScrollText className="w-4 h-4" /> Logs
    ...
    /* Metrics */
  }<div className="grid grid-cols-1 sm:grid-cols-3 gap-4"><div className="bg-white dark:bg-[#111111] border border-slate-200 dark:border-[#1e1e1e] rounded-xl p-4 flex items-center justify-between"><div><p className="text-sm font-semibold text-slate-500 dark:text-[#666666]">Total Rooms</p><p className="text-2xl font-bold text-slate-800 dark:text-[#e0e0e0] mt-1">{rooms.length}</p></div><div className="w-10 h-10 rounded-full bg-slate-50 dark:bg-[#1a1a1a] flex items-center justify-center"><Bed className="w-5 h-5 text-slate-500" /></div></div><div className="bg-slate-100 dark:bg-[#1e1e1e] dark:bg-slate-500/10 border border-emerald-200 dark:border-slate-900 dark:border-white/20 rounded-xl p-4 flex items-center justify-between"><div><p className="text-sm font-semibold text-slate-900 dark:text-white dark:text-slate-300">Available</p><p className="text-2xl font-bold text-emerald-800 dark:text-emerald-300 mt-1">{availableCount}</p></div><div className="w-10 h-10 rounded-full bg-emerald-100 dark:bg-emerald-500/20 flex items-center justify-center"><Bed className="w-5 h-5 text-slate-900 dark:text-white dark:text-slate-300" /></div></div><div className="bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 rounded-xl p-4 flex items-center justify-between"><div><p className="text-sm font-semibold text-blue-700 dark:text-blue-400">Occupied</p><p className="text-2xl font-bold text-blue-800 dark:text-blue-300 mt-1">{occupiedCount}</p></div><div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-500/20 flex items-center justify-center"><Bed className="w-5 h-5 text-blue-600 dark:text-blue-400" /></div></div></div>{
    /* Filters */
