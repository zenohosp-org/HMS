...
const EVENT_META = {
  ...
  ATTENDER_UPDATED:  { label: "Attender Updated",   cls: "bg-slate-100 text-slate-900 border-slate-200 dark:bg-[#1e1e1e] dark:text-slate-300 dark:border-[#333333]",              icon: UserCog },
};
...
function RoomLogsPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Log table */}
      <div className="bg-white dark:bg-[#111111] border border-slate-200 dark:border-[#1e1e1e] rounded-lg overflow-hidden flex flex-col">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 gap-3 text-slate-600 dark:text-[#999999]">
              ...
              return (
                ...
                >
                  ...
                  <div>
                    {log.attenderName ? (
                      <div className="flex items-center gap-1.5">
                        <Users className="w-3.5 h-3.5 text-slate-600 dark:text-[#999999] shrink-0" />
                  ...
                  <div className="md:text-right">
                    ...
                    <p className="text-[10px] text-slate-600 dark:text-[#999999] mt-0.5">{formatFull(log.createdAt)}</p>
                  </div>
                </div>
              );
            })}
        ...
        {!loading && filteredLogs.length > 0 && (
          <div className="px-6 py-3 border-t border-slate-100 dark:border-[#1e1e1e]">
            <Pagination
              currentPage={page}
