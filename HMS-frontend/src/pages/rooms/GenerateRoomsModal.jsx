    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-[#111111] rounded-2xl shadow-xl w-full max-w-md overflow-hidden border border-slate-200 dark:border-[#2a2a2a]">
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          <div>
            <label className={labelCls}>Room Prefix</label>
            <input
              type="text"
              required
              className={inputCls}
            ...
            <p className="text-xs text-slate-500 mt-1.5">
              Rooms will be generated as {formData.roomPrefix}-01, {formData.roomPrefix}-02, etc.
            </p>
          </div>
          ...
          <div>
            ...
            />
            <p className="text-xs text-slate-500 mt-1.5">Used when adding room charges to a bill.</p>
          </div>
