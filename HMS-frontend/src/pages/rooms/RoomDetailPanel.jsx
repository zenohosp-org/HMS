...
function RoomDetailPanel({ room, onClose, onViewLogs }) {
  ...
  ><X className="w-4 h-4" /></button></div><div className="flex-1 overflow-y-auto p-5 space-y-5">{
    ...
    /* Assets */
  }<div><div className="flex items-center gap-2 mb-3"><Package className="w-3.5 h-3.5 text-slate-400 dark:text-[#666666]" /><p className="text-xs font-bold text-slate-500 dark:text-[#666666] uppercase tracking-wider">Assets in Room</p></div><div className="pl-1 py-4 flex flex-col items-center justify-center rounded-lg border border-dashed border-slate-200 dark:border-[#2a2a2a]"><Package className="w-6 h-6 text-slate-300 dark:text-[#333333] mb-1.5" /><p className="text-xs text-slate-400 dark:text-[#555555]">No assets assigned yet</p></div></div></div>{
    /* Footer: View Logs */
