                            ...
                            {loading ? (
                                ...
                                <tr>
                                    <td colSpan={6} className="py-20 text-center">
                                        <div className="flex flex-col items-center gap-3">
                                            ...
                                            <p className="text-sm font-medium text-slate-400">{search ? 'No patients match your search.' : 'No patients registered yet.'}</p>
                                        </div>
                                    </td>
                                </tr>
                            ) : paginated.map(p => {
                                ...
                                return (
                                    ...
                                    >
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-slate-400 dark:text-slate-500 mt-0.5">{p.mrn}</p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-6 py-4 text-sm text-slate-600 dark:text-slate-400">
                                            {p.phone ?? <span className="text-slate-300 dark:text-slate-700">—</span>}
                                        </td>
                                        ...
                                        <td className="px-6 py-4">
                                            {p.bloodGroup ? (
                                                <span className="px-2.5 py-1 rounded-lg bg-red-50 text-red-700 border border-red-100 dark:bg-red-500/10 dark:text-red-400 dark:border-red-500/20 text-xs font-bold">
                                                    {p.bloodGroup}
                                                </span>
                                            ) : (
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <button
                                                ...
                                                onClick={e => { e.stopPropagation(); setModal({ open: true, patient: p }) }}
                                                title="Edit Patient"
                                            >
