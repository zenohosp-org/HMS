...
function Patients() {
  ...
  return <div className="flex flex-col h-full bg-slate-50 dark:bg-[#050505] p-6 gap-6">{
    /* Header */
  }<div className="flex items-center justify-between"><div className="flex items-center gap-3"><h1 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Patients</h1><span className="px-2.5 py-0.5 rounded-full bg-slate-100 dark:bg-[#1e1e1e] dark:bg-emerald-900/20 text-slate-900 dark:text-white dark:text-slate-300 text-xs font-bold border border-emerald-100 dark:border-emerald-800/30">{patients.length} registered
