...
const STATUS_STYLES = {
  SCHEDULED: "bg-blue-50 text-blue-600 border border-blue-200 dark:bg-blue-500/10 dark:text-blue-400 dark:border-blue-500/20",
  CONFIRMED: "bg-blue-50 text-blue-600 border border-blue-200 dark:bg-blue-500/10 dark:text-blue-400 dark:border-blue-500/20",
  IN_PROGRESS: "bg-amber-50 text-amber-600 border border-amber-200 dark:bg-amber-500/10 dark:text-amber-400 dark:border-amber-500/20",
  CHECKED_IN: "bg-amber-50 text-amber-600 border border-amber-200 dark:bg-amber-500/10 dark:text-amber-400 dark:border-amber-500/20",
  ...
  NO_SHOW: "bg-amber-50 text-amber-600 border border-amber-200 dark:bg-amber-500/10 dark:text-amber-400 dark:border-amber-500/20"
};
const APPT_COLORS = [
...
function AppointmentsDashboard() {
  ...
  const renderListView = () => <div className="bg-white dark:bg-[#111111] overflow-hidden flex flex-col flex-1"><div className="flex items-center justify-between p-5 border-b border-slate-200 dark:border-[#222222]"><h3 className="text-xl font-bold tracking-tight text-slate-800 dark:text-white">All Appointments</h3><div className="flex gap-2"><div className="relative"><select
    ...
    className="appearance-none bg-slate-50 dark:bg-[#1a1a1a] border border-slate-200 dark:border-[#333333] text-slate-700 dark:text-slate-500 text-sm font-medium py-2 pl-4 pr-10 rounded-lg outline-none focus:ring-2 focus:ring-slate-300 dark:focus:ring-[#444444] dark:focus:ring-[#444444] transition-all cursor-pointer"
  ...
  return <div className="flex flex-col h-full bg-slate-50 dark:bg-[#050505]">{
    ...
    >{v}</button>)}</div><div className="flex items-center gap-4"><select
      value={selectedDoctorId}
      onChange={(e) => setSelectedDoctorId(e.target.value)}
      className="appearance-none bg-white dark:bg-[#111111] border border-slate-200 dark:border-[#333333] text-slate-700 dark:text-[#cccccc] text-sm font-semibold py-2 pl-4 pr-10 rounded-lg outline-none focus:ring-2 focus:ring-slate-300 dark:focus:ring-[#444444] dark:focus:ring-[#444444] transition-all cursor-pointer shadow-sm"
