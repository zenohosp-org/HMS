...
const STATUS_STYLES = {
  ...
  COMPLETED: "bg-slate-900 dark:bg-white text-white border-transparent",
...
const APPT_COLORS = [
  ...
  "bg-slate-100 dark:bg-[#1e1e1e] text-slate-900 dark:text-white border-emerald-200 dark:bg-slate-500/10 dark:text-emerald-300 dark:border-slate-900 dark:border-white/20",
...
function AppointmentsDashboard() {
  ...
  >{v}</button>)}</div><div className="flex items-center gap-4"><select
    value={selectedDoctorId}
    onChange={(e) => setSelectedDoctorId(e.target.value)}
    className="appearance-none bg-white dark:bg-[#111111] border border-slate-200 dark:border-[#333333] text-slate-700 dark:text-[#cccccc] text-sm font-semibold py-2 pl-4 pr-10 rounded-xl outline-none focus:ring-2 focus:ring-slate-900 dark:ring-white/20 transition-all cursor-pointer shadow-sm"
