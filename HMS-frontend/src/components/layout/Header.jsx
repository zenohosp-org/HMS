...
function Header({ onMenuClick }) {
    ...
    return (
        <header className="hms-header">
            ...
            <span className="hms-header__title">Hospital Management System</span>
            <div className="hms-header__right">
                ...
                <div className="hms-header__user">
                    <div className="hms-header__user-avatar">{initials}</div>
                    <div className="hms-header__user-text">
                        <span className="hms-header__user-name">
                            {user?.firstName} {user?.lastName}
                        </span>
                        <span className="hms-header__user-role">{user?.roleDisplay}</span>
                    </div>
                    <button
                        onClick={logout}
                        title="Logout"
