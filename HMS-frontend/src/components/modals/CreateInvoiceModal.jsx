...
const TYPE_META = {
  ...
  RADIOLOGY:   { label: 'Radiology',    color: 'text-slate-900 dark:text-white dark:text-slate-400',   bg: 'bg-slate-100 dark:bg-slate-900/20',   icon: <ScanLine className="w-3 h-3" /> },
        ...
        <div className="bg-slate-50 dark:bg-[#0d0d0d] rounded-lg shadow-2xl w-full max-w-3xl max-h-[95vh] flex flex-col overflow-hidden border border-slate-200 dark:border-[#2a2a2a]">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-4">
                ...
                {!loadingSuggestions && suggestions && (
                  <div className="space-y-2">
                    ...
                    {suggestions.radiologyOrders?.map(r => {
                      ...
                      return (
                        <div key={key} className="flex items-center justify-between px-3 py-2.5 rounded-lg border border-slate-200 dark:border-[#333333] bg-slate-100 dark:bg-slate-900/5">
                          <div className="flex items-center gap-2.5">
                            <div className="w-7 h-7 rounded-lg bg-slate-100 dark:bg-slate-200 flex items-center justify-center shrink-0">
                              <ScanLine className="w-3.5 h-3.5 text-slate-900 dark:text-white dark:text-slate-300" />
                            </div>
                            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs text-slate-400 dark:text-[#666666] mb-1.5 flex items-center gap-1">
                    <FlaskConical className="w-3 h-3 text-slate-700 dark:text-[#cccccc]" /> Search Lab / Services
                  </label>
                  <div className="relative">
            ...
            <div className={cardCls}>
              ...
              {items.length === 0 ? (
                <div className="py-8 text-center text-sm text-slate-600 dark:text-[#999999] border-2 border-dashed border-slate-100 dark:border-[#1e1e1e] rounded-lg">
                  No items yet — detect from patient or add manually
                </div>
              ) : (
                <>
                  <div className="grid grid-cols-12 gap-2 pb-2 border-b border-slate-100 dark:border-[#1e1e1e] text-[10px] font-bold uppercase tracking-wider text-slate-600 dark:text-[#999999] px-1">
