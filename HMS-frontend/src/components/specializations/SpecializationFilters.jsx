...
function SpecializationFilters({ isOpen, onClose, onApply, initialFilters }) {
  ...
  return <div className="absolute top-14 right-0 z-50 w-72 bg-white dark:bg-[#111111] rounded-2xl shadow-2xl border border-slate-200 dark:border-[#222222] p-5 animate-in fade-in slide-in-from-top-2 duration-200"><div className="space-y-6">{
    /* Date Filter */
